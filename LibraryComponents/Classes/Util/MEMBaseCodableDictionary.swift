//
//  MEMBaseCodableDictionary.swift
//  MEMBase
//
...
import Foundation
public class MEMBaseCodableDictionary: Codable, CustomStringConvertible {
        ...
        public required init(from decoder: Decoder) throws {
                ...
                for key in container.allKeys {
                        ...
                        if let string: String = try? container.decode(String.self, forKey: codingKey) {
                        ...
                        } else if let nestedDict: MEMBaseCodableDictionary = try? container.decode(MEMBaseCodableDictionary.self, forKey: codingKey) {
                                ...
                                dict[key.stringValue] = array
                        } else if let nestedArrayDict: [MEMBaseCodableDictionary] = try? container.decode([MEMBaseCodableDictionary].self, forKey: codingKey) {
        ...
        public func encode(to encoder: Encoder) throws {
                ...
                for (key, value) in value {
                        ...
                        case let value as [String: Any]:
                                try container.encode(MEMBaseCodableDictionary(value: value), forKey: codingKey)
                        case let value as [String]:
                                try container.encode(value, forKey: codingKey)
                        case let value as [Int]:
                                try container.encode(value, forKey: codingKey)
                        ...
                        case let value as [Bool]:
                                try container.encode(value, forKey: codingKey)
                        case let value as [[String: Any]]:
                                try container.encode(value.map { MEMBaseCodableDictionary(value: $0) }, forKey: codingKey)
                        default:
        ...
        private func toString(value: Any) -> String {
                ...
                case let value as Bool:
                        return "\(value)"
                case let value as [String: Any]:
                        return "\(MEMBaseCodableDictionary(value: value))"
                case let value as [String]:
                        return "\(value)"
                case let value as [Int]:
                        return "\(value)"
                ...
                case let value as [Bool]:
                        return "\(value)"
                case let value as [[String: Any]]:
                        return "[".appending(value.map({ "\(MEMBaseCodableDictionary(value: $0))" }).joined(separator: ", ").appending("]"))
                default:
                        return ""
                }
        }
